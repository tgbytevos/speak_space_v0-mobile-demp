...
- `Backend/AI/` manages downloadable local models and generates summaries or to-do lists with Apple Intelligence or llama.cpp.
...
4. A note can request a summary or to-do list from Apple Intelligence or the selected local Gemma model.
